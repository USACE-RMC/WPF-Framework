...
3. **Include unit tests** that validate the new behavior
4. **Use xunit** as the testing framework
5. **Ensure a clean build** with zero errors and zero warnings
6. **Test with all three themes** (Light, Dark, Blue) to verify visual correctness
