...
{
    /// <summary>
    /// A user control for selecting a folder path with a browse button.
    /// </summary>
    /// <remarks>
    /// <para>
    ///     <b> Authors: </b>
    ...
    public partial class FolderSelectorControl : UserControl, INotifyPropertyChanged
    {
        ...
        /// </summary>
        public static readonly DependencyProperty TextProperty = DependencyProperty.Register(nameof(Text), typeof(string), typeof(FolderSelectorControl), new FrameworkPropertyMetadata(""));

        /// <summary>
        /// Gets or sets the folder path text.
        /// </summary>
        public string Text
        {
            get
        ...
        /// </summary>
        public static readonly DependencyProperty IsReadOnlyProperty = DependencyProperty.Register(nameof(IsReadOnly), typeof(bool), typeof(FolderSelectorControl), new FrameworkPropertyMetadata(false));
        ...
        /// </summary>
        public static readonly DependencyProperty TitleProperty = DependencyProperty.Register(nameof(Title), typeof(string), typeof(FolderSelectorControl), new FrameworkPropertyMetadata("Title"));
        ...
        /// </summary>
        public static readonly DependencyProperty PropertyWidthProperty = DependencyProperty.Register(nameof(PropertyWidth), typeof(GridLength), typeof(FolderSelectorControl), new FrameworkPropertyMetadata(PropertyDefaults.DefaultPropertyWidth));
        ...
        /// </summary>
        public static readonly DependencyProperty MaxPropertyWidthProperty = DependencyProperty.Register(nameof(MaxPropertyWidth), typeof(double), typeof(FolderSelectorControl), new FrameworkPropertyMetadata(PropertyDefaults.DefaultMaxPropertyWidth));
        ...
        /// </summary>
        public static readonly DependencyProperty MinPropertyWidthProperty = DependencyProperty.Register(nameof(MinPropertyWidth), typeof(double), typeof(FolderSelectorControl), new FrameworkPropertyMetadata(PropertyDefaults.DefaultMinPropertyWidth));
        ...
        /// </summary>
        public static readonly DependencyProperty ShowLeaderLineProperty = DependencyProperty.Register(nameof(ShowLeaderLine), typeof(bool), typeof(FolderSelectorControl), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        /// <summary>
        /// Delegate for the <see cref="TextChanged"/>
        /// </summary>
        ...
        {
            string folder = GeneralMethods.FolderBrowserDialog(Window.GetWindow(this));
