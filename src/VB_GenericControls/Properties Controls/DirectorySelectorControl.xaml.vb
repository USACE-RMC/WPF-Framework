...
Public Class DirectorySelectorControl
...
#Region "Members"
    ...
    ''' </summary>
    Public Shared TextProperty As DependencyProperty = DependencyProperty.Register(NameOf(Text), GetType(String), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata(""))
    ...
    Public Shared IsReadOnlyProperty As DependencyProperty = DependencyProperty.Register(NameOf(IsReadOnly), GetType(Boolean), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata(False))
    ...
    ''' </summary>
    Public Shared TitleProperty As DependencyProperty = DependencyProperty.Register(NameOf(Title), GetType(String), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata("Title"))
    ...
    ''' </summary>
    Public Shared PropertyWidthProperty As DependencyProperty = DependencyProperty.Register(NameOf(PropertyWidth), GetType(GridLength), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata(DefaultPropertyWidth))
    ...
    ''' Dependency property for the max width property.
    ''' </summary>
    Public Shared MaxPropertyWidthProperty As DependencyProperty = DependencyProperty.Register(NameOf(MaxPropertyWidth), GetType(Double), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata(DefaultMaxPropertyWidth))
    ...
    ''' </summary>
    Public Shared MinPropertyWidthProperty As DependencyProperty = DependencyProperty.Register(NameOf(MinPropertyWidth), GetType(Double), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata(DefaultMinPropertyWidth))
    ...
    ''' </summary>
    Public Shared ShowLeaderLineProperty As DependencyProperty = DependencyProperty.Register(NameOf(ShowLeaderLine), GetType(Boolean), GetType(DirectorySelectorControl), New FrameworkPropertyMetadata(False, FrameworkPropertyMetadataOptions.AffectsRender))
...
#End Region
    ...
    Private Sub FolderPathButton_Click(sender As Object, e As RoutedEventArgs)
        Dim folderPath As String = FolderBrowserDialog(Window.GetWindow(Me))
        If Not IsNothing(folderPath) AndAlso folderPath <> "" Then Text = folderPath
    End Sub
