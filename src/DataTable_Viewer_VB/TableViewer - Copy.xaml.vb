...
Public Class TableViewer2
    Private Shared Function GetDefaultCellTextblockStyle() As Style
        ...
        s.Setters.Add(New Setter(TextBlock.MarginProperty, New Thickness(3, 0, 3, 0)))
        Return s
    End Function
    Private Shared Function GetDefaultColumnHeaderTextblockStyle() As Style
        ...
        s.Setters.Add(New Setter(TextBlock.BackgroundProperty, Brushes.Transparent))
        s.Setters.Add(New Setter(TextBlock.ForegroundProperty, Brushes.Black))
        s.Setters.Add(New Setter(TextBlock.MarginProperty, New Thickness(0, 2, 0, 2)))
    ...
    Private Shared Function GetDefaultColumnHeaderBorderStyle() As Style
        ...
        s.Setters.Add(New Setter(Border.MarginProperty, New Thickness(0, 0, -1, 0)))
        s.Setters.Add(New Setter(Border.MinHeightProperty, CDbl(24)))
    ...
    Private Shared Function GetDefaultRowHeaderBorderStyle() As Style
        ...
        s.Setters.Add(New Setter(Border.BorderBrushProperty, New SolidColorBrush(Color.FromRgb(204, 206, 219))))
        s.Setters.Add(New Setter(Border.BorderThicknessProperty, New Thickness(1)))
        s.Setters.Add(New Setter(Border.MarginProperty, New Thickness(-1, 0, -1, -1)))
        s.Setters.Add(New Setter(Border.SnapsToDevicePixelsProperty, True))
        Return s
    End Function
...
#Region "Properties"
    ...
    End Function
    Public Shared ReadOnly DataViewProperty As DependencyProperty = DependencyProperty.Register(NameOf(DataView), GetType(DataTableView), GetType(TableViewer2), New UIPropertyMetadata(GetDummyTable(), New PropertyChangedCallback(AddressOf LoadView)))
    ...
    Public Shared ReadOnly AllCellsSelectedProperty As DependencyProperty = DependencyProperty.Register(NameOf(AllCellsSelected), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(False))
    Public Property AllCellsSelected As Boolean
        ...
        End Set
    End Property
    Public Shared ReadOnly RowHeightProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowHeight), GetType(Double), GetType(TableViewer2), New UIPropertyMetadata(CDbl(23)))
    Public Property RowHeight As Double
        ...
        End Set
    End Property
    Public Shared ReadOnly ColumnHeaderHeightProperty As DependencyProperty = DependencyProperty.Register(NameOf(ColumnHeaderHeight), GetType(GridLength), GetType(TableViewer2), New UIPropertyMetadata(GridLength.Auto))
    Public Property ColumnHeaderHeight As GridLength
        ...
        End Set
    End Property
    Public Shared ReadOnly ColumnHeaderTextblockStyleProperty As DependencyProperty = DependencyProperty.Register(NameOf(ColumnHeaderTextblockStyle), GetType(Style), GetType(TableViewer2), New PropertyMetadata(GetDefaultColumnHeaderTextblockStyle()))
    Public Property ColumnHeaderTextblockStyle As Style
        ...
        End Set
    End Property
    Public Shared ReadOnly ColumnHeaderBorderStyleProperty As DependencyProperty = DependencyProperty.Register(NameOf(ColumnHeaderBorderStyle), GetType(Style), GetType(TableViewer2), New PropertyMetadata(GetDefaultColumnHeaderBorderStyle()))
    ...
    Public Shared ReadOnly RowHeaderTextblockStyleProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowHeaderTextblockStyle), GetType(Style), GetType(TableViewer2), New PropertyMetadata(GetDefaultRowHeaderTextblockStyle()))
    Public Property RowHeaderTextblockStyle As Style
        ...
        End Set
    End Property
    Public Shared ReadOnly RowHeaderBorderStyleProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowHeaderBorderStyle), GetType(Style), GetType(TableViewer2), New PropertyMetadata(GetDefaultRowHeaderBorderStyle()))
    ...
    Public Shared ReadOnly EditableProperty As DependencyProperty = DependencyProperty.Register(NameOf(Editable), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(False))
    Public Property Editable As Boolean
        ...
        End Set
    End Property
    Public Shared ReadOnly HasFieldCalculatorProperty As DependencyProperty = DependencyProperty.Register(NameOf(HasFieldCalculator), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(True))
    Public Property HasFieldCalculator As Boolean
        ...
        End Set
    End Property
    Public Shared ReadOnly HasSaveButtonProperty As DependencyProperty = DependencyProperty.Register(NameOf(HasSaveButton), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(True))
    Public Property HasSaveButton As Boolean
        ...
        End Set
    End Property
    Public Shared ReadOnly HasUndoRedoButtonsProperty As DependencyProperty = DependencyProperty.Register(NameOf(HasUndoRedoButtons), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(True))
    ...
    Public Shared ReadOnly RowSelectableProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowSelectable), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(True))
    Public Property RowSelectable As Boolean
        ...
        End Set
    End Property
    Public Shared ReadOnly CellTextblockStyleProperty As DependencyProperty = DependencyProperty.Register(NameOf(CellTextblockStyle), GetType(Style), GetType(TableViewer2), New PropertyMetadata(GetDefaultCellTextblockStyle()))
    Public Property CellTextblockStyle As Style
        ...
        End Set
    End Property
    Public Shared ReadOnly SelectedColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(SelectedColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Color.FromArgb(240, 0, 120, 215))))
    Public Property SelectedColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly ActiveCellForegroundProperty As DependencyProperty = DependencyProperty.Register(NameOf(ActiveCellForeground), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Colors.White)))
    Public Property ActiveCellForeground As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly ActiveCellBackgroundProperty As DependencyProperty = DependencyProperty.Register(NameOf(ActiveCellBackground), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 21, 107, 176))))
    ...
    Public Shared ReadOnly DeSelectedColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(DeSelectedColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(Brushes.Transparent))
    Public Property DeSelectedColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly SelectedForegroundColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(SelectedForegroundColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Colors.White)))
    Public Property SelectedForegroundColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly DeSelectedForegroundColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(DeSelectedForegroundColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(Brushes.Black))
    Public Property DeSelectedForegroundColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly RowColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(Brushes.White))
    Public Property RowColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly AlternateRowColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(AlternateRowColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 243, 249, 247))))
    Public Property AlternateRowColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly RowLineColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowLineColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 53, 59, 122))))
    ...
    Public Shared ReadOnly RowLineThicknessProperty As DependencyProperty = DependencyProperty.Register(NameOf(RowLineThickness), GetType(Double), GetType(TableViewer2), New UIPropertyMetadata(CDbl(1)))
    ...
    Public Shared ReadOnly ColumnLineColorProperty As DependencyProperty = DependencyProperty.Register(NameOf(ColumnLineColor), GetType(Brush), GetType(TableViewer2), New UIPropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 53, 59, 122))))
    Public Property ColumnLineColor As Brush
        ...
        End Set
    End Property
    Public Shared ReadOnly ColumnLineThicknessProperty As DependencyProperty = DependencyProperty.Register(NameOf(ColumnLineThickness), GetType(Double), GetType(TableViewer2), New UIPropertyMetadata(CDbl(1)))
    ...
    Public Shared ReadOnly ColumnSelectableProperty As DependencyProperty = DependencyProperty.Register(NameOf(ColumnSelectable), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(True))
    ...
    Public Shared ReadOnly CellSelectableProperty As DependencyProperty = DependencyProperty.Register(NameOf(CellSelectable), GetType(Boolean), GetType(TableViewer2), New UIPropertyMetadata(True))
...
#Region "Initializing"
    Public Sub New()
        ...
        InitializeComponent()
        ' 
        _cellEditTextBox = New TextBox With {.Padding = New Thickness(0, 2, 0, 2)} ', .Margin = New Thickness(1, 1, 0, 0)}
...
#Region "Loading and Unloading Process"
    Private Shared Sub LoadView(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        ...
        If d.GetType <> GetType(TableViewer2) Then Exit Sub
        Dim thisControl = DirectCast(d, TableViewer2)
        'clear old handlers
        ...
        If IsNothing(e.NewValue) OrElse e.NewValue.GetType.BaseType <> GetType(DataTableView) Then
            ...
            '
            RemoveHandler thisControl.ColumnsGrid.SizeChanged, AddressOf thisControl.ColumnsGridSizeChanged
            '
            thisControl.GridPanel.Children.Clear()
            thisControl.RowsGrid.Children.Clear()
            thisControl.RowColorPanel.Children.Clear()
            thisControl.ColumnsGrid.Children.Clear()
            thisControl.GridPanel.RowDefinitions.Clear()
            thisControl.RowsGrid.RowDefinitions.Clear()
            thisControl.RowColorPanel.RowDefinitions.Clear()
            thisControl.ColumnsGrid.ColumnDefinitions.Clear()
            '
        ...
        Else
            ...
            For i As Int32 = 0 To newView.ColumnNames.Count - 1
                sumWidth += CInt(New FormattedText(newView.ColumnNames(i), Globalization.CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, New Typeface(New FontFamily("Segoe UI"), FontStyles.Normal, FontWeights.Bold, FontStretches.Normal), 12, Brushes.Black, pixelsPerDip).Width) + 12
                If sumWidth > thisControl.HorizontalViewerGrid.ActualWidth Then
                    thisControl._visibleColumnIndices = visibleColumns.ToArray() 'CInt(Math.Floor(HorizontalViewerGrid.ActualWidth / columnwidth)))
                    Exit For
                End If
...
#Region "Database Updated Events e.g. columns/rows added"
    ...
    Private Sub NumberOfRowsChanged()
        ...
        RowHeadersColumn.Width = New GridLength(CInt(New FormattedText(DataView.NumberOfRows.ToString, Globalization.CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, New Typeface(New FontFamily("Segoe UI"), FontStyles.Normal, FontWeights.Bold, FontStretches.Normal), 12, Brushes.Black, pixelsPerDip).Width) + 3)
        UpdateRowHeaders()
        'UpdateVisibleRows()
        SetSelectedCells()
    ...
    Private Sub NumberOfColumnsChanged()
        RemoveHandler ColumnsGrid.SizeChanged, AddressOf ColumnsGridSizeChanged
        '
        GridPanel.Children.Clear()
        RowsGrid.Children.Clear()
        RowColorPanel.Children.Clear()
        ColumnsGrid.Children.Clear()
        GridPanel.RowDefinitions.Clear()
        RowsGrid.RowDefinitions.Clear()
        RowColorPanel.RowDefinitions.Clear()
...
#End Region
    Private Sub Refresh()
        ...
        '
        'Set the horizontal scrollbar attributes
        Dim visibleSumWidth As Integer = 0
        Dim visibleColumns As New List(Of Integer)
        Dim pixelsPerDip = VisualTreeHelper.GetDpi(Me).PixelsPerDip
        For i As Int32 = 0 To DataView.ColumnNames.Count - 1
            visibleSumWidth += CInt(New FormattedText(DataView.ColumnNames(i), Globalization.CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, New Typeface(New FontFamily("Segoe UI"), FontStyles.Normal, FontWeights.Bold, FontStretches.Normal), 12, Brushes.Black, pixelsPerDip).Width) + 12
            If visibleSumWidth > HorizontalViewerGrid.ActualWidth Then
                _visibleColumnIndices = visibleColumns.ToArray() 'CInt(Math.Floor(HorizontalViewerGrid.ActualWidth / columnwidth)))
                Exit For
            End If
            visibleColumns.Add(i)
        Next

        HorizontalScrollbar.Maximum = DataView.ColumnNames.Count - _visibleColumnIndices.Count 'missingSumWidth '_visibleColumnIndices.Length - 'missing
        If CInt(Math.Floor(HorizontalScrollbar.Value)) >= CInt(HorizontalScrollbar.Maximum) Then HorizontalScrollbar.Value -= 1
        HorizontalScrollbar.ViewportSize = _visibleColumnIndices.Length

        'Update column sort order array.
    ...
    Private Sub CreateColumns()
        AddHandler ColumnsGrid.SizeChanged, AddressOf ColumnsGridSizeChanged
        ...
        For i As Int32 = 0 To DataView.ColumnNames.Count - 1
            ...
            '
            columnResizers = New GridSplitter With {.Background = Brushes.Transparent, .Width = 10, .Margin = New Thickness(0, 0, -5, 0), .VerticalAlignment = VerticalAlignment.Stretch}
            AddHandler columnResizers.MouseDoubleClick, AddressOf ResizeColumnSplitterDoubleClick
            AddHandler columnResizers.DragDelta, Sub() UpdateColumnLines()
            AddHandler columnResizers.DragCompleted, Sub() UpdateColumnLines()
            ...
            If i = DataView.ColumnNames.Count - 1 Then columnDefinitions.Width = New GridLength(1, GridUnitType.Star)
            ...
            'If i = DataView.ColumnNames.Count - 1 Then header.Margin = New Thickness(1, 0, -1, 0)
            AddHandler header.MouseRightButtonUp, AddressOf CreateColumnContextMenu
            Grid.SetColumn(header, i)
            ColumnsGrid.Children.Add(header)
            If i < DataView.ColumnNames.Count - 1 Then ColumnsGrid.Children.Add(columnResizers)
            '
            columnwidthbinding = New Binding("Width") With {.Source = columnDefinitions}
        ...
        'columnDefinitions = New ColumnDefinition With {.Width = New GridLength(0)}
        'ColumnsGrid.ColumnDefinitions.Add(columnDefinitions)
        'Create Columns Lines
        Dim lengthBinding As New Binding("ActualHeight") With {.ElementName = "GridPanel"}
        Dim gridLine As Line
        Dim aggregator As Double = 0
        '
        If DataView.ColumnNames.Count = 0 Then Exit Sub
        For i As Int32 = 0 To DataView.ColumnNames.Count
            gridLine = New Line With {.SnapsToDevicePixels = True, .X1 = aggregator, .Y1 = 0, .X2 = aggregator, .StrokeThickness = ColumnLineThickness, .Stroke = ColumnLineColor}
            BindingOperations.SetBinding(gridLine, Line.Y2Property, lengthBinding)
            If i = 0 Then
                aggregator += GridPanel.ColumnDefinitions(i).ActualWidth - (ColumnLineThickness / 2)
            Else
                aggregator += GridPanel.ColumnDefinitions(i - 1).ActualWidth - (ColumnLineThickness / 2)
            End If
...
#Region "Resize Logic"
    ...
    Private Sub ColumnsGridSizeChanged(sender As Object, e As SizeChangedEventArgs)
        UpdateColumnLines()
    End Sub
    Private Sub UpdateColumnLines()
        Dim runningWidth As Int32 = 0
        For i As Int32 = 0 To DataView.ColumnNames.Count - 1
            runningWidth += GridPanel.ColumnDefinitions(i).ActualWidth
    ...
    Private Sub Table_SizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
        ...
        '
        Dim newNumberRows As Int32 = CInt(Math.Floor(RowsAr.ActualHeight / RowHeight))
        ...
        If newNumberRows < _visibleRowCount Then
            Do
                ...
                RowColorPanel.Children.RemoveAt(RowColorPanel.Children.Count - 1)
                RowColorPanel.RowDefinitions.RemoveAt(RowColorPanel.RowDefinitions.Count - 1)
...
#Region "Adding Rows and Defining Cell Info"
    Private Sub AddRow()
        ...
        GridLinesCanvas.Children.Add(rowLine)
        'Create Row selector
        RowsGrid.RowDefinitions.Add(New RowDefinition With {.Height = New GridLength(RowHeight)})
        Dim newRowSelector As New RowHeader With {.HeaderTextblockStyle = RowHeaderTextblockStyle, .HeaderBorderStyle = RowHeaderBorderStyle}
        Grid.SetRow(newRowSelector, RowsGrid.RowDefinitions.Count - 1)
        RowsGrid.Children.Add(newRowSelector)
        'Create row color
        RowColorPanel.RowDefinitions.Add(New RowDefinition With {.Height = New GridLength(RowHeight)})
        Dim fillColor As SolidColorBrush = RowColor
        If _rowId(RowColorPanel.RowDefinitions.Count() - 1) Mod 2 <> 0 Then fillColor = AlternateRowColor
        Dim rect As New Rectangle With {.Stroke = New SolidColorBrush(Colors.Transparent), .StrokeThickness = 0, .Fill = fillColor}
        Grid.SetRow(rect, RowColorPanel.RowDefinitions.Count - 1)
        RowColorPanel.Children.Add(rect)
    End Sub
    Private Sub FillRow(rowIndex As Int32, row() As Object)
        For i As Int32 = 0 To _visibleColumnIndices.Count - 1 'DataView.ColumnNames.Count - 1
...
#Region "Vertical ScrollBar Logic"
    ...
    Private Sub UpdateRowHeaders()
        ...
        For i As Int32 = 0 To _visibleRowCount - 1
            CType(RowColorPanel.Children(i), Rectangle).Fill = If(alternate = True, AlternateRowColor, RowColor)
            CType(RowsGrid.Children(i), RowHeader).Text = GetDataRowIndex(i).ToString
...
#Region "Row Selection Logic"
    Private Sub RowsGrid_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs)
        ...
        Else
            ...
            '    counter += 1
            'Loop
            _activeCellDataColumnIndex = -1 'counter - 1
        End If
...
#End Region
    ...
    Private Sub HorizontalScrollbar_ValueChanged(sender As Object, e As RoutedPropertyChangedEventArgs(Of Double))

    End Sub

    Private Sub HorizontalScrollbar_IsEnabledChanged(sender As Object, e As DependencyPropertyChangedEventArgs)
