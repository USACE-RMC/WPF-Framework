...
namespace Xceed.Wpf.AvalonDock.Layout
{
  ...
  public abstract class LayoutContent : LayoutElement, IXmlSerializable, ILayoutElementForFloatingWindow, IComparable<LayoutContent>, ILayoutPreviousContainer, ILayoutInitialContainer
  {
    ...
    public static readonly DependencyProperty IconSourceProperty = DependencyProperty.Register(
        nameof( IconSource ), typeof( ImageSource ), typeof( LayoutContent ),
        new FrameworkPropertyMetadata( null, OnIconSourceChanged ) );

    /// <summary>
    /// Gets or sets the icon displayed in the document tab header.
    /// </summary>
    ...
    {
      ( (LayoutContent)d ).RaisePropertyChanged( nameof( IconSource ) );
    }
