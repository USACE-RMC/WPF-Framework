...
namespace OxyPlot
{
    ...
    public class SvgWriter : XmlWriterBase
    {
        ...
        /// <summary>
        /// Writes an SVG path element with the specified path data, fill color, and transform.
        /// </summary>
        /// <param name="pathData">The SVG path data string (e.g. "M 0,0 L 10,10 Z").</param>
        /// <param name="fill">The fill color.</param>
        /// <param name="transform">The transform attribute value (e.g. "translate(10,20) rotate(45)").</param>
        public void WritePath(string pathData, OxyColor fill, string transform)
        {
            this.WriteStartElement("path");
            this.WriteAttributeString("d", pathData);
            this.WriteAttributeString("transform", transform);
