...
namespace OxyPlot.Series
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScatterErrorPoint"/> class with asymmetric error bars.
        /// This constructor provides backward compatibility with the old API.
        /// </summary>
        ...
        public ScatterErrorPoint(double x, double y, double lowerErrorX, double upperErrorX, double lowerErrorY, double upperErrorY, double size, double value, object tag = null)
