...
namespace OxyPlot.Series
{
    ...
    public class BoxPlotItem
    {
        ...
        /// <remarks>This property is provided for backward compatibility. Use <see cref="X"/> instead.</remarks>
        ...
        /// <summary>
        /// Gets or sets the box minimum value (box bottom).
        /// </summary>
        /// <value>The box minimum value.</value>
        /// <remarks>This property is provided for backward compatibility. Use <see cref="BoxBottom"/> instead.</remarks>
        public double BoxMinimum
        {
            get => this.BoxBottom;
        ...
        /// <summary>
        /// Gets or sets the box maximum value (box top).
        /// </summary>
        /// <value>The box maximum value.</value>
        /// <remarks>This property is provided for backward compatibility. Use <see cref="BoxTop"/> instead.</remarks>
        public double BoxMaximum
        {
            get => this.BoxTop;
