...
namespace OxyPlot.Series
{
    ...
    public abstract class BarSeriesBase<T> : XYAxisSeries, IBarSeries where T : BarItemBase
    {
        ...
        protected double GetActualBarWidth()
        {
            ...
            if (categoryAxis == null || this.Manager == null)
            {
                return this.BarWidth;
            }

            var maxWidth = this.Manager.GetMaxWidth();
            if (maxWidth == 0)
            {
                return this.BarWidth;
            }

            return this.BarWidth / (1 + categoryAxis.GapWidth) / maxWidth;
        }
        ...
        protected void UpdateValidData()
        {
            ...
            if (this.Manager == null || this.ActualItems == null)
            {
                return;
            }
