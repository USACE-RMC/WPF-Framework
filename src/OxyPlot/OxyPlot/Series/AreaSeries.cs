...
namespace OxyPlot.Series
{
    ...
    public class AreaSeries : LineSeries
    {
        ...
        /// <summary>
        /// Reusable buffer for combining polygon screen points during rendering.
        /// </summary>
        private readonly List<ScreenPoint> polygonBuffer = new List<ScreenPoint>();
        ...
        public override void Render(IRenderContext rc)
        {
            ...
            for (int chunkIndex = 0; chunkIndex < chunksOfPoints.Count; chunkIndex++)
            {
                ...
                this.polygonBuffer.Clear();
                this.polygonBuffer.AddRange(pts2);
                this.polygonBuffer.AddRange(pts);
                var allPts = this.polygonBuffer;
