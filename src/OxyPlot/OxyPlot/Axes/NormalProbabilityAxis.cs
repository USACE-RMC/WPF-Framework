...
{
    /// <summary>
    /// Creates a Normal Probability scaled axis.
    /// </summary>
    public class NormalProbabilityAxis : Axis
    {
        ...
        public override double InverseTransform(double sx)
        {
            ...
            return 1-Normal.CDF((sx / this.Scale) + this.Offset);
        }
        ...
        public override double Transform(double x)
        {
            ...
            return (Normal.InverseCDF(1-x) - this.Offset) * this.Scale;
        }
