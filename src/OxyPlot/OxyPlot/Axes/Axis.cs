...
namespace OxyPlot.Axes
{
    ...
    public abstract class Axis : PlotElement
    {
        ...
        /// <summary>
        /// Gets the desired size of the axis.
        /// </summary>
        /// <remarks>
        /// This property is provided for backward compatibility.
        /// For horizontal axes (Bottom, Top), the Height is the axis size.
        /// For vertical axes (Left, Right), the Width is the axis size.
        /// </remarks>
        public OxySize DesiredSize
        {
            get
            {
                return this.Position == AxisPosition.Left || this.Position == AxisPosition.Right
                    ? new OxySize(this.PositionTierSize, 0)
                    : new OxySize(0, this.PositionTierSize);
            }
        }
