...
namespace OxyPlot.Wpf
{
    ...
    public abstract class Axis : FrameworkElement, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register(
            nameof(Maximum), typeof(double), typeof(Axis), new PropertyMetadata(double.NaN, AppearanceChanged));
        ...
        public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register(
            nameof(Minimum), typeof(double), typeof(Axis), new PropertyMetadata(double.NaN, AppearanceChanged));
