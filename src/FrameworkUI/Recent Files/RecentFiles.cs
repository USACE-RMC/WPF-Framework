...
namespace FrameworkUI
{
    ...
    public class RecentFiles : Separator
    {
        ...
        /// <summary>
        /// Gets and sets the parent file menu.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the number of recent files to show in the menu.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the XML file path for storing the recent file list.
        /// </summary>
